...
import {dispatchKeyboardEvent, dispatchFakeEvent} from '@angular-mdc/web/testing';
...
describe('MdcDialog Service', () => {
  ...
  it('#should open a simple dialog', () => {
    ...
    dispatchFakeEvent(actionButtonDebugElement as Element, 'click');
    viewContainerFixture.detectChanges();
  });
  ...
  it('#should have null for button action', () => {
    ...
    expect(dialogRef.componentInstance.buttonAction).toBe('');
  });

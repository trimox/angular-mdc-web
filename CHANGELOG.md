# [6.0.0-canary.9](https://github.com/trimox/angular-mdc-web/compare/v5.1.1...v6.0.0-canary.9) (2020-05-05)
...
* **select:** Should remove ripple span if outlined ([#2249](https://github.com/trimox/angular-mdc-web/issues/2249)) ([351d2c8](https://github.com/trimox/angular-mdc-web/commit/351d2c8b7b55e9111e050c462fcdf1a4069e1332))
...
* **textarea:** Set default variant to outlined ([#2233](https://github.com/trimox/angular-mdc-web/issues/2233)) ([2d67d6b](https://github.com/trimox/angular-mdc-web/commit/2d67d6b0334f7f7ab1e415dad56c6bcc1b875f87)), closes [#2231](https://github.com/trimox/angular-mdc-web/issues/2231)
...
* **form-field:** Add nowrap property ([#2240](https://github.com/trimox/angular-mdc-web/issues/2240)) ([b6c2114](https://github.com/trimox/angular-mdc-web/commit/b6c21140d7ee2dfe42235f79b1f31104e0ee3aa4))
* **form-field:** Add spaceBetween property ([#2241](https://github.com/trimox/angular-mdc-web/issues/2241)) ([1768c6a](https://github.com/trimox/angular-mdc-web/commit/1768c6afc673559904b9588bf1eacac3f308ae7f)), closes [#2205](https://github.com/trimox/angular-mdc-web/issues/2205)
...
* **icon-button:** Add onIcon and offIcon properties ([#2239](https://github.com/trimox/angular-mdc-web/issues/2239)) ([128b225](https://github.com/trimox/angular-mdc-web/commit/128b2254658ca1624e0458f33eadcca613733520)), closes [#2237](https://github.com/trimox/angular-mdc-web/issues/2237) [#2238](https://github.com/trimox/angular-mdc-web/issues/2238)
...
* **select:** Improved Helper Text ([#2248](https://github.com/trimox/angular-mdc-web/issues/2248)) ([9062e3c](https://github.com/trimox/angular-mdc-web/commit/9062e3c5d14e0236a60ceaca3d8206d76260c058)), closes [#2246](https://github.com/trimox/angular-mdc-web/issues/2246)
...
* **textfield:** Improved Helper Text and Character Counter ([#2235](https://github.com/trimox/angular-mdc-web/issues/2235)) ([888276a](https://github.com/trimox/angular-mdc-web/commit/888276ab9ee9a1f4588786a8b51bc36df53c11d0)), closes [#2232](https://github.com/trimox/angular-mdc-web/issues/2232) [#2228](https://github.com/trimox/angular-mdc-web/issues/2228) [#2229](https://github.com/trimox/angular-mdc-web/issues/2229) [#2230](https://github.com/trimox/angular-mdc-web/issues/2230)
...
* **icon-button:** * Removed `toggle()` method, use `on: boolean` instead.
* **icon:** Removed `clickable` property, use `mdc-icon-button` component instead.
* **textfield:** Renamed property `characterCounter` to `charCounter`
* **textfield:** Removed `MdcHelperText` component, use `helper: string` instead
* **textfield:** Removed `MdcCharacterCounter` component
* **textfield:** Validation messages are set using `validationMessage: string`. See examples
* **textfield:** Helper text is set using `helper: string`. See examples
* **textfield:** Persistent helper text is enabled using `helperPersistent: boolean`. See examples

* **select:** Removed `mdcSelectHelperText` component, use `helper: string` instead
* **select:** Validation messages are set using `validationMessage: string`. See examples
* **select:** Helper text is set using `helper: string`. See examples
* **select:** Persistent helper text is enabled using `helperPersistent: boolean`. See examples

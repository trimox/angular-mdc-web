 ...
 *
 * @param pkg The package for which to get entry points, e.g., 'theme'.
 * @returns An array of secondary entry-points names
 */
export function getSecondaryEntryPointsForPackage(pkg: BuildPackage) {
  ...
  // E.g., extract "portal" from "from '@angular-mdc/web/dialog';".
...
/**
 * Partitions nodes into groups by depth.
 */

export const navigationLinks = [
  ...
  { name: 'Icon', route: 'icon-demo', icon: 'star', desc: 'Icon supports SVG, font ligatures and font icons using CSS.' },
  { name: 'Icon Toggle', route: 'icon-toggle-demo', icon: 'favorite', desc: 'Icon toggle buttons allow a single choice to be selected or deselected.' },

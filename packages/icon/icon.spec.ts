...
import {SafeResourceUrl, DomSanitizer, SafeHtml, By} from '@angular/platform-browser';
...
describe('MdcMaterialIcon', () => {
  ...
  describe('basic behaviors', () => {
    ...
    let testComponent: MaterialIconTest;

    beforeEach(() => {
      fixture = TestBed.createComponent(MaterialIconTest);
...
@Component({template: '<i materialIcons>home</i>'})

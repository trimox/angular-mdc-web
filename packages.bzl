...
ANGULAR_CDK_PACKAGE_VERSION = "^9.2.0"
MDC_PACKAGE_VERSION = "6.0.0-canary.cbb3f28ca.0"
TSLIB_PACKAGE_VERSION = "^1.11.1"

VERSION_PLACEHOLDER_REPLACEMENTS = {
    "0.0.0-CDK": ANGULAR_CDK_PACKAGE_VERSION,
...
# List of Angular library UMD bundles which are processed by ngcc.
...
ANGULAR_LIBRARY_VIEW_ENGINE_UMDS = getUmdFilePaths(ANGULAR_NO_NGCC_BUNDLES, False) + getUmdFilePaths(ANGULAR_NGCC_BUNDLES, False)

ANGULAR_LIBRARY_IVY_UMDS = getUmdFilePaths(ANGULAR_NO_NGCC_BUNDLES, False) + getUmdFilePaths(ANGULAR_NGCC_BUNDLES, True)

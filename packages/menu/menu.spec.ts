...
import {dispatchFakeEvent, dispatchMouseEvent, dispatchKeyboardEvent} from '@angular-mdc/web/testing';
...
describe('MdcMenu', () => {
  ...
  describe('MenuSelectionGroup', () => {
    ...
    it('#menu should open', fakeAsync(() => {
      ...
      //expect(listItemInstance.getListItemElement().classList).toContain('mdc-menu--selected');
    }));
